    ...
    for (x,y,w,h) in faces:
        ...
        if(profile!=None):
            if conf <=70:
                ...
                cv2.putText(img,"ID: "+str(profile[0]), (x,y+h+20),font, 1, (255,255,255)) #Draw the text
                cv2.putText(img,"Name:"+str(profile[1]),(x,y+h+45),font, 1,(255,255,255));
                cv2.putText(img,"Age: "+str(profile[2]),(x,y+h+70),font, 1,(255,255,255));
                cv2.putText(img,"Gender: "+str(profile[3]),(x,y+h+95),font, 1, (255,255,255));
            else:
                cv2.rectangle(img,(x,y),(x+w,y+h),(0,0,255),5)#(b,g,r)
                cv2.putText(img,"NOT IN THE SYSTEM", (x,y+h+20),font, 1, (255,255,255)) #Draw the text
